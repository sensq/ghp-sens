...
function BlenderAnimation(anim){
	...
	if (keyframe != anim.currentKeyframe){
		meshBlender.morphTargetInfluences[anim.lastKeyframe] = false;
		meshBlender.morphTargetInfluences[anim.currentKeyframe] = true;
		meshBlender.morphTargetInfluences[keyframe] = false;
		anim.lastKeyframe = anim.currentKeyframe;
		anim.currentKeyframe = keyframe;
	}
